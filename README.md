...
In contrast to the plain `terraform_google_compute_address` resource this module has better features.
...
- **`address_type`**: _(Optional `string`)_
  ...
  The type of address to reserve. Default value is EXTERNAL. Possible values are INTERNAL and EXTERNAL.
  Default is `EXTERNAL`.
